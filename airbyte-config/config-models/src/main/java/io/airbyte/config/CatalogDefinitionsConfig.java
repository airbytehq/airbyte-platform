...
public class CatalogDefinitionsConfig {
  ...
  /**
   * This method is used to get the path to the local connector catalog.
   * Its override is intended for Airbyte developers to test out changes
   * to the catalog locally.
   */
  ...
  /**
   * This method is used to get the relative path used for writing the local connector catalog
   * to resources.
   *
   * Note: We always want to write to the default path.
