...
public class RefreshConfig implements Serializable {
   ...
   *
   */
  @JsonProperty("streamsToRefresh")
  private List<RefreshStream> streamsToRefresh = new ArrayList<RefreshStream>();
  /**
  ...
  private final static long serialVersionUID = 1619579535606883801L;
   ...
   */
  @JsonProperty("streamsToRefresh")
  public List<RefreshStream> getStreamsToRefresh() {
    return streamsToRefresh;
  }
   ...
   */
  @JsonProperty("streamsToRefresh")
  public void setStreamsToRefresh(List<RefreshStream> streamsToRefresh) {
    this.streamsToRefresh = streamsToRefresh;
  }

  public RefreshConfig withStreamsToRefresh(List<RefreshStream> streamsToRefresh) {
    this.streamsToRefresh = streamsToRefresh;
    return this;
  }
  ...
  public RefreshConfig withNamespaceDefinition(JobSyncConfig.NamespaceDefinitionType namespaceDefinition) {
    this.namespaceDefinition = namespaceDefinition;
    return this;
  }
  ...
  public RefreshConfig withNamespaceFormat(String namespaceFormat) {
    this.namespaceFormat = namespaceFormat;
    return this;
  }
  ...
  public RefreshConfig withPrefix(String prefix) {
    this.prefix = prefix;
    return this;
  }
  ...
  public RefreshConfig withConfiguredAirbyteCatalog(ConfiguredAirbyteCatalog configuredAirbyteCatalog) {
    this.configuredAirbyteCatalog = configuredAirbyteCatalog;
    return this;
  }
  ...
  public RefreshConfig withSourceDockerImage(String sourceDockerImage) {
    this.sourceDockerImage = sourceDockerImage;
    return this;
  }
  ...
  public RefreshConfig withSourceProtocolVersion(io.airbyte.commons.version.Version sourceProtocolVersion) {
    this.sourceProtocolVersion = sourceProtocolVersion;
    return this;
  }
  ...
  public RefreshConfig withDestinationDockerImage(String destinationDockerImage) {
    this.destinationDockerImage = destinationDockerImage;
    return this;
  }
  ...
  public RefreshConfig withDestinationProtocolVersion(io.airbyte.commons.version.Version destinationProtocolVersion) {
    this.destinationProtocolVersion = destinationProtocolVersion;
    return this;
  }
  ...
  public RefreshConfig withOperationSequence(List<StandardSyncOperation> operationSequence) {
    this.operationSequence = operationSequence;
    return this;
  }
  ...
  public RefreshConfig withWebhookOperationConfigs(JsonNode webhookOperationConfigs) {
    this.webhookOperationConfigs = webhookOperationConfigs;
    return this;
  }
  ...
  public RefreshConfig withSyncResourceRequirements(SyncResourceRequirements syncResourceRequirements) {
    this.syncResourceRequirements = syncResourceRequirements;
    return this;
  }
  ...
  public RefreshConfig withIsSourceCustomConnector(Boolean isSourceCustomConnector) {
    this.isSourceCustomConnector = isSourceCustomConnector;
    return this;
  }
  ...
  public RefreshConfig withIsDestinationCustomConnector(Boolean isDestinationCustomConnector) {
    this.isDestinationCustomConnector = isDestinationCustomConnector;
    return this;
  }
  ...
  public RefreshConfig withWorkspaceId(UUID workspaceId) {
    this.workspaceId = workspaceId;
    return this;
  }
  ...
  public RefreshConfig withSourceDefinitionVersionId(UUID sourceDefinitionVersionId) {
    this.sourceDefinitionVersionId = sourceDefinitionVersionId;
    return this;
  }
  ...
  public RefreshConfig withDestinationDefinitionVersionId(UUID destinationDefinitionVersionId) {
    this.destinationDefinitionVersionId = destinationDefinitionVersionId;
    return this;
  }
  ...
  public RefreshConfig withAdditionalProperty(String name, Object value) {
    this.additionalProperties.put(name, value);
    return this;
  }
  ...
  public String toString() {
    ...
    sb.append(RefreshConfig.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    sb.append("streamsToRefresh");
    sb.append('=');
    sb.append(((this.streamsToRefresh == null) ? "<null>" : this.streamsToRefresh));
    sb.append(',');
  ...
  public int hashCode() {
    ...
    result = ((result * 31) + ((this.streamsToRefresh == null) ? 0 : this.streamsToRefresh.hashCode()));
  ...
  public boolean equals(Object other) {
    ...
    if ((other instanceof RefreshConfig) == false) {
      return false;
    }
    RefreshConfig rhs = ((RefreshConfig) other);
    return (((((((((((((((((((this.webhookOperationConfigs == rhs.webhookOperationConfigs)
        ...
        && ((this.streamsToRefresh == rhs.streamsToRefresh)
            || ((this.streamsToRefresh != null) && this.streamsToRefresh.equals(rhs.streamsToRefresh))))
