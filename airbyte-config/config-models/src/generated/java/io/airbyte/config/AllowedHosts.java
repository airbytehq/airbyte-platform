...
public class AllowedHosts implements Serializable {
   ...
   * source or destination means that access to all hosts is allowed. An empty list here means that no
  ...
  private final static long serialVersionUID = 7554322936380969697L;
  ...
  public boolean equals(Object other) {
    ...
    return (((this.hosts == rhs.hosts) || ((this.hosts != null) && this.hosts.equals(rhs.hosts)))
