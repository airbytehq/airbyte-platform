...
public class FailureReason implements Serializable {
  ...
  /**
   * Categorizes well known errors into types for programmatic handling. If not set, the type of error
   * is not well known.
   *
   */
  ...
  /**
   * Human readable failure description for consumption by technical system operators, like Airbyte
   * engineers or OSS users.
   *
   */
  ...
  /**
   * True if it is known that retrying may succeed, e.g. for a transient failure. False if it is known
   * that a retry will not succeed, e.g. for a configuration issue. If not set, retryable status is
   * not well known.
   *
   */
  ...
  private final static long serialVersionUID = -7589290421207303748L;
  ...
  public FailureReason withStreamDescriptor(StreamDescriptor streamDescriptor) {
    this.streamDescriptor = streamDescriptor;
    return this;
  }
  ...
  public FailureReason withAdditionalProperty(String name, Object value) {
    this.additionalProperties.put(name, value);
    return this;
  }
  ...
  public boolean equals(Object other) {
    ...
    return (((((((((((this.retryable == rhs.retryable) || ((this.retryable != null) && this.retryable.equals(rhs.retryable)))
        && ((this.streamDescriptor == rhs.streamDescriptor)
