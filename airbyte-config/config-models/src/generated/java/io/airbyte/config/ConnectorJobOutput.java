...
public class ConnectorJobOutput implements Serializable {
  ...
  private StandardSyncOutput replicate;
  /**
   * FailureSummary
   * <p>
   *
  ...
  private final static long serialVersionUID = -6985338874311421900L;
   ...
   */
  @JsonProperty("replicate")
  public StandardSyncOutput getReplicate() {
    return replicate;
  }
   ...
   */
  @JsonProperty("replicate")
  public void setReplicate(StandardSyncOutput replicate) {
    this.replicate = replicate;
  }

  public ConnectorJobOutput withReplicate(StandardSyncOutput replicate) {
    this.replicate = replicate;
    return this;
  }
  ...
  public String toString() {
    ...
    sb.append("replicate");
    sb.append('=');
    sb.append(((this.replicate == null) ? "<null>" : this.replicate));
    sb.append(',');
  ...
  public int hashCode() {
    int result = 1;
    result = ((result * 31) + ((this.replicate == null) ? 0 : this.replicate.hashCode()));
  ...
  public boolean equals(Object other) {
    ...
    return (((((((((this.replicate == rhs.replicate) || ((this.replicate != null) && this.replicate.equals(rhs.replicate)))
        ...
        && ((this.connectorConfigurationUpdated == rhs.connectorConfigurationUpdated)
            || ((this.connectorConfigurationUpdated != null) && this.connectorConfigurationUpdated.equals(rhs.connectorConfigurationUpdated))))
        && ((this.discoverCatalogId == rhs.discoverCatalogId)
            || ((this.discoverCatalogId != null) && this.discoverCatalogId.equals(rhs.discoverCatalogId))))
        && ((this.failureReason == rhs.failureReason) || ((this.failureReason != null) && this.failureReason.equals(rhs.failureReason))))
        && ((this.outputType == rhs.outputType) || ((this.outputType != null) && this.outputType.equals(rhs.outputType))))
