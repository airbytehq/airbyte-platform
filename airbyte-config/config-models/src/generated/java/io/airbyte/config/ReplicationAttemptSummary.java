...
public class ReplicationAttemptSummary implements Serializable {
  ...
  /**
   * Number of streams in the configured catalog
   *
   */
  @JsonProperty("streamCount")
  @JsonPropertyDescription("Number of streams in the configured catalog")
  ...
  public ReplicationAttemptSummary withStreamCount(Long streamCount) {
    this.streamCount = streamCount;
    return this;
  }
