...
public class JobSyncConfig implements Serializable {
  ...
  /**
   * Whether this sync job used on-demand capacity (for billing purposes).
   *
   */
  @JsonProperty("usedOnDemandCapacity")
  @JsonPropertyDescription("Whether this sync job used on-demand capacity (for billing purposes).")
  private Boolean usedOnDemandCapacity = false;
  @JsonIgnore
   ...
   */
  @JsonProperty("usedOnDemandCapacity")
  public Boolean getUsedOnDemandCapacity() {
    return usedOnDemandCapacity;
  }
   ...
   */
  @JsonProperty("usedOnDemandCapacity")
  public void setUsedOnDemandCapacity(Boolean usedOnDemandCapacity) {
    this.usedOnDemandCapacity = usedOnDemandCapacity;
  }

  public JobSyncConfig withUsedOnDemandCapacity(Boolean usedOnDemandCapacity) {
    this.usedOnDemandCapacity = usedOnDemandCapacity;
    return this;
  }
