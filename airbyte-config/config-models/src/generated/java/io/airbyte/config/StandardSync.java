...
public class StandardSync implements Serializable {
  ...
  @JsonPropertyDescription("When enabled, this connection will use on-demand capacity if committed capacity is exhausted")
  ...
  public StandardSync withOnDemandEnabled(Boolean onDemandEnabled) {
    this.onDemandEnabled = onDemandEnabled;
    return this;
  }
  ...
  public String toString() {
    ...
    sb.append('=');
    sb.append(((this.onDemandEnabled == null) ? "<null>" : this.onDemandEnabled));
    sb.append(',');
  ...
  public int hashCode() {
    ...
    result = ((result * 31) + ((this.onDemandEnabled == null) ? 0 : this.onDemandEnabled.hashCode()));
    return result;
  }
  ...
  public boolean equals(Object other) {
    ...
    return (((((((((((((((((((((((((((this.sourceId == rhs.sourceId) || ((this.sourceId != null) && this.sourceId.equals(rhs.sourceId)))
        ...
        && ((this.onDemandEnabled == rhs.onDemandEnabled)
            || ((this.onDemandEnabled != null) && this.onDemandEnabled.equals(rhs.onDemandEnabled)));
  }
