...
public class SsoConfig implements Serializable {
  ...
  /**
   * Default organization role granted to users provisioned by this SSO configuration
   *
   */
  @JsonProperty("defaultRole")
  private Permission.PermissionType defaultRole;
  @JsonIgnore
   ...
   */
  @JsonProperty("defaultRole")
  public Permission.PermissionType getDefaultRole() {
    return defaultRole;
  }
   ...
   */
  @JsonProperty("defaultRole")
  public void setDefaultRole(Permission.PermissionType defaultRole) {
    this.defaultRole = defaultRole;
  }

  public SsoConfig withDefaultRole(Permission.PermissionType defaultRole) {
    this.defaultRole = defaultRole;
    return this;
  }
  ...
  public String toString() {
    ...
    sb.append('=');
    sb.append(((this.defaultRole == null) ? "<null>" : this.defaultRole));
    sb.append(',');
  ...
  public int hashCode() {
    ...
    result = ((result * 31) + ((this.defaultRole == null) ? 0 : this.defaultRole.hashCode()));
  ...
  public boolean equals(Object other) {
    ...
    return ((this.ssoConfigId == rhs.ssoConfigId) || ((this.ssoConfigId != null) && this.ssoConfigId.equals(rhs.ssoConfigId)))
        ...
        && ((this.defaultRole == rhs.defaultRole) || ((this.defaultRole != null) && this.defaultRole.equals(rhs.defaultRole)))
