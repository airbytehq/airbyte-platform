...
public class NotificationSettings implements Serializable {
   ...
   *
   */
  @JsonProperty("sendOnConnectionSyncQueued")
  @JsonPropertyDescription("Notification Settings for a type of event")
  private NotificationItem sendOnConnectionSyncQueued;
  @JsonIgnore
   ...
   */
  @JsonProperty("sendOnConnectionSyncQueued")
  public NotificationItem getSendOnConnectionSyncQueued() {
    return sendOnConnectionSyncQueued;
  }
   ...
   */
  @JsonProperty("sendOnConnectionSyncQueued")
  public void setSendOnConnectionSyncQueued(NotificationItem sendOnConnectionSyncQueued) {
    this.sendOnConnectionSyncQueued = sendOnConnectionSyncQueued;
  }

  public NotificationSettings withSendOnConnectionSyncQueued(NotificationItem sendOnConnectionSyncQueued) {
    this.sendOnConnectionSyncQueued = sendOnConnectionSyncQueued;
    return this;
  }
  ...
  public String toString() {
    ...
    sb.append(',');
    sb.append("sendOnConnectionSyncQueued");
    sb.append('=');
    sb.append(((this.sendOnConnectionSyncQueued == null) ? "<null>" : this.sendOnConnectionSyncQueued));
    sb.append(',');
  ...
  public int hashCode() {
    ...
    result = ((result * 31) + ((this.sendOnConnectionSyncQueued == null) ? 0 : this.sendOnConnectionSyncQueued.hashCode()));
  ...
  public boolean equals(Object other) {
    ...
    return ((this.sendOnConnectionUpdateActionRequired == rhs.sendOnConnectionUpdateActionRequired)
        ...
        && ((this.sendOnBreakingChangeSyncsDisabled == rhs.sendOnBreakingChangeSyncsDisabled)
            || ((this.sendOnBreakingChangeSyncsDisabled != null)
                && this.sendOnBreakingChangeSyncsDisabled.equals(rhs.sendOnBreakingChangeSyncsDisabled)))
        && ((this.sendOnSuccess == rhs.sendOnSuccess)
            || ((this.sendOnSuccess != null) && this.sendOnSuccess.equals(rhs.sendOnSuccess)))
        && ((this.sendOnFailure == rhs.sendOnFailure)
            || ((this.sendOnFailure != null) && this.sendOnFailure.equals(rhs.sendOnFailure)))
        ...
        && ((this.sendOnConnectionSyncQueued == rhs.sendOnConnectionSyncQueued)
            || ((this.sendOnConnectionSyncQueued != null) && this.sendOnConnectionSyncQueued.equals(rhs.sendOnConnectionSyncQueued)))
