...
public class StandardSyncOperation implements Serializable {
  ...
  private final static long serialVersionUID = -7106116454866361851L;
  ...
  public StandardSyncOperation withAdditionalProperty(String name, Object value) {
    this.additionalProperties.put(name, value);
    return this;
  }
  ...
  public boolean equals(Object other) {
    ...
    return ((((((((this.operatorWebhook == rhs.operatorWebhook)
        || ((this.operatorWebhook != null) && this.operatorWebhook.equals(rhs.operatorWebhook)))
        && ((this.tombstone == rhs.tombstone) || ((this.tombstone != null) && this.tombstone.equals(rhs.tombstone))))
        && ((this.name == rhs.name) || ((this.name != null) && this.name.equals(rhs.name))))
        && ((this.operationId == rhs.operationId) || ((this.operationId != null) && this.operationId.equals(rhs.operationId))))
        && ((this.operatorType == rhs.operatorType) || ((this.operatorType != null) && this.operatorType.equals(rhs.operatorType))))
