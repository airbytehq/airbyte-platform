...
public class WorkerDestinationConfig implements Serializable {
  ...
  private State state;
  @JsonProperty("supportRefreshes")
  private Boolean supportRefreshes = false;
  @JsonIgnore
  private Map<String, Object> additionalProperties = new HashMap<String, Object>();
  private final static long serialVersionUID = -4317120652706586657L;
  ...
  @JsonProperty("supportRefreshes")
  public Boolean getSupportRefreshes() {
    return supportRefreshes;
  }

  @JsonProperty("supportRefreshes")
  public void setSupportRefreshes(Boolean supportRefreshes) {
    this.supportRefreshes = supportRefreshes;
  }

  public WorkerDestinationConfig withSupportRefreshes(Boolean supportRefreshes) {
    this.supportRefreshes = supportRefreshes;
    return this;
  }
  ...
  public WorkerDestinationConfig withAdditionalProperty(String name, Object value) {
    this.additionalProperties.put(name, value);
    return this;
  }
  ...
  public String toString() {
    ...
    sb.append(',');
    sb.append("supportRefreshes");
    sb.append('=');
    sb.append(((this.supportRefreshes == null) ? "<null>" : this.supportRefreshes));
    sb.append(',');
  ...
  public int hashCode() {
    int result = 1;
    result = ((result * 31) + ((this.supportRefreshes == null) ? 0 : this.supportRefreshes.hashCode()));
  ...
  public boolean equals(Object other) {
    ...
    return ((((((((this.supportRefreshes == rhs.supportRefreshes)
        || ((this.supportRefreshes != null) && this.supportRefreshes.equals(rhs.supportRefreshes)))
        && ((this.destinationConnectionConfiguration == rhs.destinationConnectionConfiguration) || ((this.destinationConnectionConfiguration != null)
            && this.destinationConnectionConfiguration.equals(rhs.destinationConnectionConfiguration))))
