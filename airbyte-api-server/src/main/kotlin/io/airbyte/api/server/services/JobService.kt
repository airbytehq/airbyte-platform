...
interface JobService {
  ...
  fun sync(connectionId: UUID, userInfo: String?): JobResponse

  fun reset(connectionId: UUID, userInfo: String?): JobResponse

  fun cancelJob(jobId: Long, userInfo: String?): JobResponse

  fun getJobInfoWithoutLogs(jobId: Long, userInfo: String?): JobResponse
