...
class SyncWorkflowTest {
  ...
  void setUp() {
    ...
    final BeanRegistration<ActivityOptions> longActivityOptionsBeanRegistration = mock();
    ...
    final BeanRegistration<ActivityOptions> shortActivityOptionsBeanRegistration = mock();
    ...
    final BeanRegistration<ActivityOptions> refreshSchemaActivityOptionsBeanRegistration = mock();
    ...
    final BeanRegistration<ActivityOptions> asyncActivityOptionsBeanRegistration = mock();
    ...
    final BeanRegistration<ActivityOptions> workloadStatusCheckActivityOptionsBeanRegistration = mock();
