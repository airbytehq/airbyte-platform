...
@Tag("oauth")
class SquareOAuthFlowIntegrationTest : OAuthFlowIntegrationTest() {
  override fun getCredentialsPath(): Path = CREDENTIALS_PATH

  override fun getFlowImplementation(
    oauthService: OAuthService,
    httpClient: HttpClient,
  ): OAuthFlowImplementation = SquareOAuthFlow(httpClient)
  ...
  companion object {
    protected val CREDENTIALS_PATH: Path = Path.of("secrets/square.json")
