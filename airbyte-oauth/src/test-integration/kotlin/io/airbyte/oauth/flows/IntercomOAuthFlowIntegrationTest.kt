...
@Tag("oauth")
class IntercomOAuthFlowIntegrationTest : OAuthFlowIntegrationTest() {
  override fun getCredentialsPath(): Path = CREDENTIALS_PATH

  override fun getFlowImplementation(
    oauthService: OAuthService,
    httpClient: HttpClient,
  ): OAuthFlowImplementation = IntercomOAuthFlow(httpClient)
  ...
  companion object {
    protected val CREDENTIALS_PATH: Path = Path.of("secrets/intercom.json")
    protected const val REDIRECT_URL: String = "http://localhost:8000/code"
