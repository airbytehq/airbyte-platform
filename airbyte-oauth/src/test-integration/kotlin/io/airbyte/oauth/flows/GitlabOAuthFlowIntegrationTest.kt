...
@Tag("oauth")
class GitlabOAuthFlowIntegrationTest : OAuthFlowIntegrationTest() {
  override fun getCredentialsPath(): Path = CREDENTIALS_PATH

  override fun getFlowImplementation(
    oauthService: OAuthService,
    httpClient: HttpClient,
  ): OAuthFlowImplementation = GitlabOAuthFlow(httpClient)
  ...
  companion object {
    protected val CREDENTIALS_PATH: Path = Path.of("secrets/gitlab.json")
