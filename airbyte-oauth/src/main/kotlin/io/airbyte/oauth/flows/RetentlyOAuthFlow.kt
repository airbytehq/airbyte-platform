 ...
 * Retently Oauth.
 */
class RetentlyOAuthFlow : BaseOAuth2Flow {
  ...
  companion object {
    private const val AUTHORIZE_URL = "https://app.retently.com/api/oauth/authorize"
    private const val ACCESS_TOKEN_URL = "https://app.retently.com/api/oauth/token"
  }
}
