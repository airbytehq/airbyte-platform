...
/** SharePoint OAuth. */
public class MicrosoftSharepointOAuthFlow extends BaseOAuth2Flow {

  private static final String fieldName = "tenant_id";

  public MicrosoftSharepointOAuthFlow(final HttpClient httpClient) {
    super(httpClient);
  }

  @VisibleForTesting
  public MicrosoftSharepointOAuthFlow(
