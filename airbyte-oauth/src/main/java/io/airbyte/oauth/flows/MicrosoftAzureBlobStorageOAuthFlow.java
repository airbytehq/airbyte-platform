 ...
 */
public class MicrosoftAzureBlobStorageOAuthFlow extends BaseOAuth2Flow {

  private static final String fieldName = "tenant_id";

  public MicrosoftAzureBlobStorageOAuthFlow(final HttpClient httpClient) {
    super(httpClient);
  }

  @VisibleForTesting
  public MicrosoftAzureBlobStorageOAuthFlow(final HttpClient httpClient, final Supplier<String> stateSupplier) {
    super(httpClient, stateSupplier);
  }

  private String getScopes() {
    return "offline_access%20https://storage.azure.com/.default";
  }
