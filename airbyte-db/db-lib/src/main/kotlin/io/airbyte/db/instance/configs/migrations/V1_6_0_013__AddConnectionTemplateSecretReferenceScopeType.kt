...
class V1_6_0_013__AddConnectionTemplateSecretReferenceScopeType : BaseJavaMigration() {
  ...
  override fun migrate(context: Context) {
    ...
    ctx.alterType(secretReferenceScopeType).addValue(connectionTemplateTable).execute()
  }
}
