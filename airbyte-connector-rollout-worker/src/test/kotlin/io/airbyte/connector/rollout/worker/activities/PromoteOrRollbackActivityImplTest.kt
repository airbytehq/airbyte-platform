...
class PromoteOrRollbackActivityImplTest {
  ...
  fun `test promoteOrRollback starts GHA and calls connectorRolloutApi`(actionType: ActionType) {
    every { connectorRolloutApi.updateConnectorRolloutFinalizing(any()) } returns getMockConnectorRolloutResponse()
    ...
    verify { connectorRolloutApi.updateConnectorRolloutFinalizing(any()) }
