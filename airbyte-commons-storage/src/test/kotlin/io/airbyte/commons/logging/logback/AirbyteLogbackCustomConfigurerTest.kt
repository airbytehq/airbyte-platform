...
private class AirbyteLogbackCustomConfigurerTest {
  ...
  fun testCreateApplicationRollingAppender() {
    ...
    val appender = configurer.createApplicationRollingAppender(context = context, discriminatorValue = discriminatorValue)
  ...
  fun testCreateOperationsJobFileAppender() {
    ...
    val appender = configurer.createOperationsJobFileAppender(context = context, discriminatorValue = discriminatorValue)
