...
private class MaskedDataConverterTest {
  ...
  companion object {
    ...
    private const val REDACTED_LOGGED_SQL_VALUES =
      (
        "2024-03-19 20:03:43 \u001B[43mdestination\u001B[0m > ERROR pool-4-thread-1 i.a.c.i.d.a.FlushWorkers(flush\$lambda$6):192 " +
          "Flush Worker (632c9) -- flush worker " +
    ...
    private const val REDACTED_LOGGED_RECORD_CONTENTS: String =
      (
        "2024-03-21 12:19:08 \u001B[43mdestination\u001B[0m > ERROR i.a.c.i.b.Destination" +
          "\$ShimToSerializedAirbyteMessageConsumer(consumeMessage):120" +
          " Received invalid message:${AirbyteSecretConstants.SECRETS_MASK}"
      )
    private const val TEST_LOGGED_SQL_VALUES: String =
      (
        "2024-03-19 20:03:43 \u001B[43mdestination\u001B[0m > ERROR pool-4-thread-1 " +
          "i.a.c.i.d.a.FlushWorkers(flush\$lambda\$6):192 Flush Worker (632c9) -- flush worker " +
          "error: java.lang.RuntimeException: org.jooq.exception.DataAccessException: SQL [insert into " +
          "\"airbyte_internal\".\"public_raw__stream_foo\" (_airbyte_raw_id, _airbyte_data, _airbyte_meta, _airbyte_extracted_at, " +
    ...
    private const val TEST_LOGGED_RECORD_CONTENTS: String =
      (
        "2024-03-21 12:19:08 \u001B[43mdestination\u001B[0m > ERROR " +
          "i.a.c.i.b.Destination\$ShimToSerializedAirbyteMessageConsumer(consumeMessage):120 " +
