...
{{- define "airbyte.workloadApiServer.host" }}
    {{- .Values.workloadApiServer.host | default (ternary (include "airbyte.common.airbyteUrl" .) (printf "http://%s-workload-api-server-svc.%s:%d" .Release.Name (include "airbyte.namespace" .) (int .Values.workloadApiServer.service.port)) (eq (include "airbyte.cluster.type" .) "data-plane")) }}
{{- end }}
