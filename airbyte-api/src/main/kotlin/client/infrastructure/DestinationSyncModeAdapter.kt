...
/**
 * Custom Moshi adapter that handles the use of [DestinationSyncMode].
 * <p />
 ...
 */
class DestinationSyncModeAdapter {
  @ToJson
  fun toJson(value: DestinationSyncMode): String {
    return value.value.lowercase()
  }

  @FromJson
  fun fromJson(value: String): DestinationSyncMode {
    return DestinationSyncMode.decode(value)!!
  }
}
