...
class RetryState(
  ...
  class RetryStateBuilder internal constructor() {
    // Micronaut-data 4.5 requires the id field we annotate with autogenerated be non-null,
    // so we default to this value, which Micronaut-data ultimate ignores.
    private var id: UUID = DEFAULT_ID
    ...
    fun id(id: UUID?): RetryStateBuilder {
      // Micronaut-data requires id be non-null, but it may be null when querying by job id
      if (id != null) {
        this.id = id
      }
      return this
  ...
  companion object {
    ...
    @JvmField
    val DEFAULT_ID: UUID = UUID.fromString("00000000-0000-0000-0000-000000000000")
  }
}
