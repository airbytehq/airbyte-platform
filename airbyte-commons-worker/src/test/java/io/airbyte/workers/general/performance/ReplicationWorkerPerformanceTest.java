...
public abstract class ReplicationWorkerPerformanceTest {
  ...
  public void executeOneSync() throws InterruptedException {
    ...
    final OldStreamStatusTracker oldStreamStatusTracker = new OldStreamStatusTracker(mock(AirbyteApiClient.class), mock(TestClient.class));
    final CachingFeatureFlagClient ffClient = mock(CachingFeatureFlagClient.class);
    final List<ApplicationEventListener<ReplicationAirbyteMessageEvent>> listeners = List.of(
        ...
        new AirbyteStreamStatusMessageEventListener(oldStreamStatusTracker, ffClient));
    ...
    final StreamStatusCachingApiClient streamStatusApiClient = mock(StreamStatusCachingApiClient.class);
    final ReplicationWorkerHelper replicationWorkerHelper =
        new ReplicationWorkerHelper(airbyteMessageDataExtractor, fieldSelector, dstNamespaceMapper, messageTracker, syncPersistence,
            ...
            Optional.empty(), airbyteApiClient, mock(StreamStatusCompletionTracker.class), streamStatusTracker, streamStatusApiClient, true);
