  ...
  private Map<String, String> getWorkerMetadata() {
    ...
    return Maps.newHashMap(
        ImmutableMap.<String, String>builder()
            ...
            .put(EnvVar.SIDECAR_KUBE_CPU_LIMIT.name(), configs.getSocatSidecarKubeCpuLimit())
            .put(EnvVar.SIDECAR_KUBE_CPU_REQUEST.name(), configs.getSocatSidecarKubeCpuRequest())
            .put(EnvVar.SIDECAR_KUBE_MEMORY_LIMIT.name(), configs.getSocatSidecarKubeCpuLimit())
            .put(EnvVar.SIDECAR_KUBE_MEMORY_REQUEST.name(), configs.getSocatSidecarKubeCpuRequest())
