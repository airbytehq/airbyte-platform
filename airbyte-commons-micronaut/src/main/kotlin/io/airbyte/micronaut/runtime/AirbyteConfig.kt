...
internal const val DEFAULT_KEYCLOAK_READ_TIMEOUT = "PT5S"
...
data class AirbyteKeycloakConfig(
  ...
  val connectTimeout: Duration = Duration.parse(DEFAULT_KEYCLOAK_CONNECT_TIMEOUT),
  ...
  val readTimeout: Duration = Duration.parse(DEFAULT_KEYCLOAK_READ_TIMEOUT),
