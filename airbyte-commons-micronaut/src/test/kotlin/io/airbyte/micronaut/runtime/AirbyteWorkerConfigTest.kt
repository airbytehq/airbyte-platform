...
internal class AirbyteWorkerConfigDefaultTest {
  ...
  fun testLoadingValuesFromConfig() {
    ...
    assertEquals("", airbyteWorkerConfig.job.kubernetes.main.container.imagePullSecret)
...
internal class AirbyteWorkerConfigOverridesTest {
  ...
  fun testLoadingValuesFromConfig() {
    ...
    assertEquals("test-main-image-pull-secret", airbyteWorkerConfig.job.kubernetes.main.container.imagePullSecret)
