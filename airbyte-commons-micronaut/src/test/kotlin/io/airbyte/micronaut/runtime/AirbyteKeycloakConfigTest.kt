...
internal class AirbyteKeycloakConfigDefaultTest {
  ...
  fun testLoadingValuesFromConfig() {
    ...
    assertEquals(DEFAULT_KEYCLOAK_MCP_CLIENT_ID, airbyteKeycloakConfig.mcpClientId)
    assertEquals(DEFAULT_KEYCLOAK_MCP_CLIENT_SOURCE_REALM, airbyteKeycloakConfig.mcpClientSourceRealm)
...
internal class AirbyteKeycloakConfigStiggTest {
  ...
  fun testLoadingValuesFromConfig() {
    ...
    assertEquals("test-mcp-client-id", airbyteKeycloakConfig.mcpClientId)
    assertEquals("test-mcp-client-source-realm", airbyteKeycloakConfig.mcpClientSourceRealm)
