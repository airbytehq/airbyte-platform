...
const columnHelper = createColumnHelper<ConnectorBuilderProjectStreamReadSlicesItemPagesItemRecordsItem>();

export const RecordTable = React.memo(
  ({ records }: { records: ConnectorBuilderProjectStreamReadSlicesItemPagesItemRecordsItem[] }) => {
