...
interface SyncCatalogRowHookFormProps
 ...
 */
export const SyncCatalogRowHookForm: React.FC<SyncCatalogRowHookFormProps & { className?: string }> = ({
  streamNode,
  updateStreamNode,
  namespaceDefinition,
  namespaceFormat,
