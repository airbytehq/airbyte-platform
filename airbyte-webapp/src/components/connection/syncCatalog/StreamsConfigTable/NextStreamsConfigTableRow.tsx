...
import { IndexerType } from "../StreamPathSelect";
import { SyncModeOption, SyncModeSelect } from "../SyncModeSelect";

interface NextStreamsConfigTableRowProps {
...
export const NextStreamsConfigTableRow: React.FC<NextStreamsConfigTableRowProps> = ({
  stream,
  destName,
  destNamespace,
  onSelectSyncMode,
