...
interface StreamsConfigTableHeaderHookFormProps
  extends Pick<HookFormConnectionFormValues, "namespaceDefinition" | "namespaceFormat" | "prefix"> {
...
/**
 * react-hook-form sync catalog table header component
 */
export const StreamsConfigTableHeaderHookForm: React.FC<StreamsConfigTableHeaderHookFormProps> = ({
  streams,
  onStreamsChanged,
  syncSwitchDisabled,
  namespaceDefinition,
  ...
  const { setValue } = useFormContext<HookFormConnectionFormValues>();
