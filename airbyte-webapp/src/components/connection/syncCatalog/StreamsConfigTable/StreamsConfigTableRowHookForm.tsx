...
import { LocationWithStateHookForm } from "../../ConnectionForm/SyncCatalogHookFormField";
import { CellText } from "../CellText";
import { SyncModeSelect, SyncModeValue } from "../SyncModeSelect";
import { FieldPathType } from "../utils";

interface StreamsConfigTableRowHookFormProps {
 ...
 */
const StreamsConfigTableRowHookFormInner: React.FC<StreamsConfigTableRowHookFormProps & { className?: string }> = ({
  stream,
  destName,
  destNamespace,
  onSelectSyncMode,
  ...
  const { state: locationState, pathname } = useLocation() as LocationWithStateHookForm;
...
export const StreamsConfigTableRowHookForm = memo(StreamsConfigTableRowHookFormInner);
