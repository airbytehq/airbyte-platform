...
import { ConnectionConfigurationHookFormCard } from "components/connection/ConnectionForm/ConnectionConfigurationHookFormCard";
import { EditControlsHookForm } from "components/connection/ConnectionForm/EditControlsHookForm";
import {
  HookFormConnectionFormValues,
  useConnectionHookFormValidationSchema,
...
import { SyncCatalogHookFormField } from "components/connection/ConnectionForm/SyncCatalogHookFormField";
...
const SchemaChangeMessageHookForm: React.FC = () => {
  const { isDirty } = useFormState<HookFormConnectionFormValues>();
...
export const ConnectionReplicationHookFormPage: React.FC = () => {
  ...
  const onFormSubmit = useCallback(
    async (values: HookFormConnectionFormValues) => {
          ...
          <FlexContainer direction="column">
            ...
            <SchemaChangeBackdrop>
              ...
              <div className={styles.editControlsContainer}>
                <EditControlsHookForm onCancel={discardRefreshedSchema} />
              </div>
            </SchemaChangeBackdrop>
          </FlexContainer>
        </Form>
