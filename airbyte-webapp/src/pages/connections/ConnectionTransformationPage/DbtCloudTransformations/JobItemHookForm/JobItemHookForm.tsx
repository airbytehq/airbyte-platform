...
import styles from "./JobItemHookForm.module.scss";

interface JobItemHookFormProps {
  job: DbtCloudJob;
  removeJob: () => void;
  isLoading: boolean;
  key?: string;
 ...
 * @constructor
 */
export const JobItemHookForm: React.FC<JobItemHookFormProps> = ({
  job,
  removeJob,
  isLoading,
  ...restProps
}: JobItemHookFormProps) => {
