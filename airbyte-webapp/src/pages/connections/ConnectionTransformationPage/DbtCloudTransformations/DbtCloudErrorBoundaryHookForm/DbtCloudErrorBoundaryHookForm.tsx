...
import styles from "./DbtCloudErrorBoundaryHookForm.module.scss";
...
export class DbtCloudErrorBoundaryHookForm extends React.Component<
  React.PropsWithChildren<DbtCloudErrorBoundaryProps>
> {
