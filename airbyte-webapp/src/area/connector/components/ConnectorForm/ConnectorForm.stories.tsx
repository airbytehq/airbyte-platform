...
export const Oneof: StoryObj<typeof ConnectorForm> = {
  ...Template,
  args: {
    selectedConnectorDefinitionSpecification: {
      ...TempConnector,
...
const json = {
  ...
  properties: {
    ...
    credentials_json: {
      type: "string",
      description:
        'The contents of the JSON service account key. Check out the <a href="https://docs.airbyte.io/integrations/destinations/bigquery">docs</a> if you need help generating this key. Default credentials will be used if this field is left empty.',
      title: "Credentials JSON",
      airbyte_secret: true,
    },
  },
...
export const Preview: StoryObj<React.FC<React.ComponentProps<typeof ConnectorForm> & PreviewProps>> = {
  ...
  argTypes: {
    ...
    full: hidden,
    formId: hidden,
    selectedConnectorDefinition: hidden,
    selectedConnectorDefinitionSpecification: hidden,
    isEditMode: hidden,
    connectorId: hidden,
    connectionTestSuccess: hidden,
    isTestConnectionInProgress: hidden,
    bodyClassName: hidden,
    headerBlock: hidden,
    renderFooter: hidden,
    connectionSpecification: { type: { name: "object", value: {}, required: true } },
  },
};
