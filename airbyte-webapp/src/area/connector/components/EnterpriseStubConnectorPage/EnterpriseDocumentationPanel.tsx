...
import {
  prepareMarkdown,
  removeFirstHeading,
} from "area/connector/components/ConnectorDocumentationLayout/DocumentationPanel";
import styles from "area/connector/components/ConnectorDocumentationLayout/DocumentationPanel.module.scss";
