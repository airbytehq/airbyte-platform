import styles from "./StreamStatusLoadingSpinner.module.scss";

interface SpinnerProps {
  className?: string;
}

export const StreamStatusLoadingSpinner: React.FC<SpinnerProps> = ({ className }) => (
  <span className={className}>
    <svg width="22" height="22" viewBox="0 0 22 22" fill="none" className={styles.spinner}>
      <path
        fillRule="evenodd"
        clipRule="evenodd"
