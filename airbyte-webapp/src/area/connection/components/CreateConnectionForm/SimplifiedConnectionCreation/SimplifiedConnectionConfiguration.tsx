...
import { CreateConnectionFormControls } from "area/connection/components/ConnectionForm/CreateConnectionFormControls";
import { FormConnectionFormValues } from "area/connection/components/ConnectionForm/formConfig";
import { DESTINATION_ID_PARAM } from "area/connection/components/CreateConnection/DefineDestination";
...
const FirstNav: React.FC = () => {
  ...
  return (
    <FlexContainer justifyContent="space-between" alignItems="center" className={styles.fixedBottomNav}>
      <Link
        to={{
...
const SecondNav: React.FC = () => {
  ...
  return (
    <FlexContainer justifyContent="space-between" className={styles.fixedBottomNav}>
      <Link
        to={{
          pathname: createLink(
