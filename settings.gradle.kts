...
include(":oss:airbyte-configuration-processor")
...
project(":oss:airbyte-api:server-api-client").projectDir = file("airbyte-api/server-api-client")
...
project(":oss:airbyte-api:manifest-server-api").projectDir = file("airbyte-api/manifest-server-api")
...
project(":oss:airbyte-configuration-processor").projectDir = file("airbyte-configuration-processor")
