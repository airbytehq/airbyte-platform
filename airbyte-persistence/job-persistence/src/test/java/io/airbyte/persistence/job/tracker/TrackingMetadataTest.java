...
class TrackingMetadataTest {
  ...
  void testgenerateJobAttemptMetadataWithNulls() {
    ...
    final Job job = new Job(1, JobConfig.ConfigType.SYNC, UNUSED, new JobConfig(), List.of(attempt), JobStatus.PENDING, 0L, 0, 0, true);
  ...
  void testGenerateJobAttemptMetadataToleratesNullInputs() {
    ...
    final Job jobWithNoAttempts = new Job(1, JobConfig.ConfigType.SYNC, UNUSED, new JobConfig(), List.of(), JobStatus.PENDING, 0L, 0, 0, true);
    ...
    final Job jobWithNullOutput =
        new Job(1, JobConfig.ConfigType.SYNC, UNUSED, new JobConfig(), List.of(mockAttemptWithNullOutput), JobStatus.PENDING, 0L, 0, 0, true);
    ...
    final Job jobWithoutSyncInfo =
        new Job(1, JobConfig.ConfigType.SYNC, UNUSED, new JobConfig(), List.of(mockAttemptWithOutput), JobStatus.PENDING, 0L, 0, 0, true);
