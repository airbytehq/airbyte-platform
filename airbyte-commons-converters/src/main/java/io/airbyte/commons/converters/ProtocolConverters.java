...
public class ProtocolConverters {
  ...
  public static io.airbyte.api.client2.model.generated.StreamDescriptor streamDescriptorToClient(final io.airbyte.protocol.models.StreamDescriptor protocolStreamDescriptor) {
    return new io.airbyte.api.client2.model.generated.StreamDescriptor(protocolStreamDescriptor.getName(), protocolStreamDescriptor.getNamespace());
  }
  ...
  @SuppressWarnings("LineLength")
  public static io.airbyte.protocol.models.StreamDescriptor clientStreamDescriptorToProtocol(final io.airbyte.api.client2.model.generated.StreamDescriptor clientStreamDescriptor) {
