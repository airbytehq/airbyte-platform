...
class EnvVarConfigBeanFactory {
  ...
  fun apiAuthSecretEnv(
    @Value("\${$WORKLOAD_API_PREFIX.bearer-token-secret-name}") bearerTokenSecretName: String,
    @Value("\${$WORKLOAD_API_PREFIX.bearer-token-secret-key}") bearerTokenSecretKey: String,
