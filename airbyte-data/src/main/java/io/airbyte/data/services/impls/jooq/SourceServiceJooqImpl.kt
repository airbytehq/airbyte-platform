...
class SourceServiceJooqImpl(
  ...
  override fun listGrantedSourceDefinitions(
    ...
    listActorDefinitionsJoinedWithGrants<StandardSourceDefinition?>(
      workspaceId,
      ScopeType.workspace,
      JoinType.JOIN,
      ActorType.source,
  ...
  override fun listGrantableSourceDefinitions(
    ...
    listActorDefinitionsJoinedWithGrants<MutableMap.MutableEntry<StandardSourceDefinition?, Boolean?>?>(
      workspaceId,
      ScopeType.workspace,
  ...
  private fun sourceDefQuery(
    ...
    database
      ...
      .map<StandardSourceDefinition?> { record: Record? ->
        DbConverter.buildStandardSourceDefinition(
          record,
          retrieveDefaultMaxSecondsBetweenMessages(
        ...
        Consumer { standardSourceDefinition: StandardSourceDefinition? ->
          ...
          if (isExistingConfig) {
            ctx
              ...
              .set<UUID?>(Tables.ACTOR_DEFINITION.ID, standardSourceDefinition.getSourceDefinitionId())
              .set<String?>(Tables.ACTOR_DEFINITION.NAME, standardSourceDefinition.getName())
              .set<String?>(Tables.ACTOR_DEFINITION.ICON, standardSourceDefinition.getIcon())
              .set<String?>(Tables.ACTOR_DEFINITION.ICON_URL, standardSourceDefinition.getIconUrl())
              .set<ActorType?>(Tables.ACTOR_DEFINITION.ACTOR_TYPE, ActorType.source)
              .set<SourceType?>(
              ...
              ).set<Boolean?>(Tables.ACTOR_DEFINITION.TOMBSTONE, standardSourceDefinition.getTombstone())
              .set<Boolean?>(Tables.ACTOR_DEFINITION.PUBLIC, standardSourceDefinition.getPublic())
              .set<Boolean?>(Tables.ACTOR_DEFINITION.CUSTOM, standardSourceDefinition.getCustom())
              .set<Boolean?>(Tables.ACTOR_DEFINITION.ENTERPRISE, standardSourceDefinition.getEnterprise())
              .set<JSONB?>(
                Tables.ACTOR_DEFINITION.RESOURCE_REQUIREMENTS,
                if (standardSourceDefinition.getResourceRequirements() == null) {
                  null
                } else {
                  JSONB.valueOf(Jsons.serialize<ScopedResourceRequirements?>(standardSourceDefinition.getResourceRequirements()))
                },
              ...
              .set<Int?>(
                ...
                if (standardSourceDefinition.getMetrics() == null) {
                  ...
                  JSONB.valueOf(Jsons.serialize<ConnectorRegistryEntryMetrics?>(standardSourceDefinition.getMetrics()))
                },
              ).where(Tables.ACTOR_DEFINITION.ID.eq(standardSourceDefinition.getSourceDefinitionId()))
              .execute()
          } else {
